...
describe('CalcService', () => {
  ...
  it('should to solve a multi components task with functions - second example', () => {
    expect(service.Invoke('Abs(-3)')).toBe(3);
  });

  it('should to solve a multi components task with functions - three example', () => {
